...
const RitualFormModal = ({ onClose }: { onClose: () => void }) => {
    ...
    return (
        <div className="fixed inset-0 bg-background/90 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in-50">
            <div className="relative w-full max-w-md mx-auto bg-card p-6 rounded-2xl shadow-2xl border border-border">
                <Button variant="ghost" size="icon" onClick={onClose} className="absolute top-2 right-2 rounded-full h-8 w-8">
                    <X className="h-5 w-5" />
...
export default function ChamaEternaPage() {
  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      ...
      {showRitual && <RitualFormModal onClose={() => setShowRitual(false)} />}
