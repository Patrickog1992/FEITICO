...
// ====================================================================
// NOVO FORMULÁRIO DE RITUAL (MODAL)
// ====================================================================
...
const RitualForm = ({ onClose, checkoutUrl }: { onClose: () => void, checkoutUrl: string }) => {
    ...
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50 animate-in fade-in-50">
        <div className="relative w-full max-w-md mx-auto bg-card p-6 rounded-2xl shadow-2xl border border-border my-12 animate-in fade-in-50 slide-in-from-bottom-10">
            <Button
                variant="ghost"
                size="icon"
                onClick={onClose}
            ...
            <div className="space-y-4 my-8">
                <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="check1" className="text-sm">Eu entendo que é necessário fé para que esse feitiço funcione.</Label>
                </div>
                <div className="flex items-center space-x-2">
                    <Checkbox id="check2" checked={checkbox2} onCheckedChange={(checked) => setCheckbox2(!!checked)} />
                    <Label htmlFor="check2" className="text-sm">Eu não contarei a ninguém sobre o feitiço (isso ira causar o rompimento do encatamento).</Label>
                </div>
                <div className="flex items-center space-x-2">
                    <Checkbox id="check3" checked={checkbox3} onCheckedChange={(checked) => setCheckbox3(!!checked)} />
                    <Label htmlFor="check3" className="text-sm">Eu entendo que uma vez lançado esse feitiço não pode ser desfeito.</Label>
                </div>
            </div>
            ...
            <div>
                <Form {...form}>
                    <form onSubmit={(e) => e.preventDefault()} className="space-y-4 mt-4">
                        ...
                        />
                        <Button onClick={handleCheckout} size="lg" className="w-full font-bold bg-green-600 text-white hover:bg-green-700 animate-button-glow-success text-lg py-3 h-auto">
  ...
  return (
    <>
      ...
      <div className="bg-background text-foreground min-h-screen">
          ...
          <div className="w-full">
            ...
            <header className="text-center my-8 md:my-12 px-4 max-w-4xl mx-auto">
              <h1 className="text-3xl md:text-4xl font-bold font-headline text-primary uppercase">
                Sussurre o nome da pessoa desejada nesta chama sagrada… e em até
                5 noites, ela vai ficar totalmente obcecada por você ou alguém
                novo surgirá, tomado por um desejo impossível de ignorar.
              </h1>
            </header>
              ...
              <>
                <Section className="text-center">
                  ...
                  <Paragraph className="mt-6 font-semibold text-foreground">
                    Ele ou ela vai se revirar na cama à noite, incapaz de tirar
                    você da cabeça. E, na quinta noite, vai rastejar de volta
                    para você — ou surgir na sua vida com uma intensidade
                    inexplicável — como se a vida dele(a) dependesse disso.
                  </Paragraph>
                </Section>
                ...
                <Section>
                  ...
                  <Paragraph>
                    E com certeza não fico sentada(o) chorando, me perguntando por
                    que a pessoa que eu quero “precisa de espaço”.
                  </Paragraph>
                  <Paragraph>
                  ...
                  <Paragraph>
                    ...
                    trazer de volta — ou atrair pela primeira vez — a uma
                    sacerdotisa que guarda uma chama antiga que queima há mais de
                    1.500 anos.
                  </Paragraph>
                  <Paragraph>Ela sussurrou o nome dele ou dela no fogo.</Paragraph>
                  <Paragraph>
                    E em menos de 48 horas, minha realidade começou a mudar.
                  </Paragraph>
                  <Paragraph>
                    Mensagens.
                    <br />
                    ...
                    Atenção inesperada.
                    <br />
                    Conexões surgindo do nada.
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Implorando. Chorando. Rastejando de volta — ou se
                    aproximando com uma intensidade que eu nunca tinha vivido antes
                    — como alguém que perdeu completamente o controle.
                  </Paragraph>
                </Section>

                <Section>
                  <SectionTitle>
                    A Última Vez Que Ele (Ou Ela) Se Afastou…
                    <br />
                    Ou quando ninguém especial parecia aparecer na minha vida…
                  </SectionTitle>
                  <Paragraph>
                  ...
                  <Paragraph>
                    Me deixar no vácuo.
                    <br />
                    Agir como se o que eu sentia não tivesse significado nada.
                  </Paragraph>
                  <Paragraph className="font-bold text-xl text-center">
                    Ahhh… que fofo.
                  </Paragraph>
                  <Paragraph>
                    Entreguei o nome — ou a intenção clara de atrair o amor certo
                    — à Sacerdotisa Azara.
                    <br />
                    Ela acendeu a vela sagrada em seu templo de fogo, pronunciou o
                    nome ou abriu o caminho energético, e deixou o fogo fazer o
                    trabalho.
                  </Paragraph>
                  ...
                  <Paragraph className="italic">
                    “Tive o sonho mais estranho com você. Não consigo parar de
                    pensar em você.”
                  </Paragraph>
                  <Paragraph>Na terceira noite?</Paragraph>
                  <Paragraph className="italic">
                    37 ligações perdidas.
                    <br />
                    Mensagens sem parar.
                    <br />
                    Ou uma conexão tão intensa que parecia destino:
                  </Paragraph>
                  <Paragraph className="italic">
                    “Me desculpa… não sei o que está acontecendo comigo. Eu
                    preciso te ver.”
                  </Paragraph>
                  ...
                  <Paragraph>
                    Disse que sentia o peito em chamas e que eu era a única coisa
                ...
                <Section>
                  ...
                  <Paragraph>
                    Choram abraçadas ao travesseiro.
                    <br />
                    Imploram atenção.
                    <br />
                    Stalkeiam redes sociais.
                    <br />
                    Ou simplesmente esperam o “amor aparecer”.
                  </Paragraph>
                  ...
                  <Paragraph>
                    O amor não volta por espaço.
                    <br />E não aparece por acaso.
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Ele volta — ou surge — quando algo se agarra à alma e não
                    solta mais.
                  </Paragraph>
                  <Paragraph className="font-bold">
                  ...
                  <Paragraph>
                    ...
                    Não convence.
                    <br />
                    Ela queima o seu nome — ou a sua energia — no espírito da
                    pessoa certa até você ser tudo em que ela consegue pensar.
                  </Paragraph>
                </Section>

                <Section>
                  <SectionTitle>
                    O Segredo Proibido dos Templos de Fogo da Pérsia
                  </SectionTitle>
                  <Image
                  ...
                  />
                  <Paragraph>
                    Isso não é um truque moderno de “manifestação”.
                  </Paragraph>
                  <Paragraph>
                    Não são velas de loja barata nem pensamentos positivos.
                  </Paragraph>
                  <Paragraph>
                    É um ritual de fogo antigo que remonta a mais de 3.000 anos,
                    às sacerdotisas zoroastristas da Pérsia.
                  </Paragraph>
                  <Paragraph>
                    Elas sabiam algo que foi escondido das pessoas por séculos:
                  </Paragraph>
                  <Paragraph className="font-bold text-primary border-l-4 border-primary pl-4">
                    Todo ser humano tem um ponto na alma que pode ser incendiado.
                    E quando é aceso, ele queima por uma única pessoa — e apenas
                    uma.
                  </Paragraph>
                  <Paragraph>
                    Rainhas e reis usavam isso para manter seus amores leais. Tão
                ...
                <Section>
                  <SectionTitle>
                    AS PESSOAS ACHAM QUE ESTÃO NO CONTROLE DE TUDO.
                  </SectionTitle>
                ...
                <Section>
                  ...
                  <Paragraph>
                    Não é “manifestar por seis meses e torcer para dar certo”.
                  </Paragraph>
                  <Paragraph>
                    A Sacerdotisa Azara sussurra o nome na chama sagrada e, em até
                    5 noites, o mundo da pessoa vira de cabeça para baixo.
                  </Paragraph>

                  <div className="space-y-4 mt-6">
                    <p>
                      <strong>Noite 1: A Primeira Faísca</strong>
                      <br />
                      No momento em que o nome entra na chama, algo muda. A pessoa
                      vai se sentir inquieta naquela noite. Vai se revirar às 3 da
                      manhã sem saber por quê. Seu rosto vai piscar na mente dela.
                      Sentirá uma dor estranha no peito que não consegue explicar.
                    </p>
                    <p>
                      <strong>Noite 2: O Calor Aumenta</strong>
                      <br />
                      Começa a pensar em você mais. Muito mais. Vai se pegar
                      olhando fotos antigas suas. Revivendo conversas. A ideia de
                      você com outra pessoa vai deixá-la enjoada.
                    </p>
                    <p>
                      <strong>Noite 3: O Fogo se Espalha</strong>
                      <br />
                      Agora não consegue mais se livrar de você. Vai sonhar com
                      você de forma tão real que acorda confusa. Os amigos vão
                      perceber que algo está errado. Vai mandar uma mensagem fraca
                      só para “testar o terreno”, porque não aguenta mais a
                      pressão.
                    </p>
                    <p>
                      <strong>Noite 4: O Incêndio</strong>
                      <br />
                      Está perdendo o controle. Não consegue focar no trabalho.
                      Não sente prazer em nada. Todas as outras pessoas parecem
                      sem graça perto de você. O fogo queimou tudo. Só você restou
                      na mente dela.
                    </p>
                    <p>
                      <strong>Noite 5: Rendição Total</strong>
                      <br />
                      Ela quebra. O orgulho? Sumiu. As defesas? Viraram cinzas.
                      Liga. Manda mensagem. Aparece. Chora, pede desculpas e jura
                      que nunca mais vai te deixar. Diz coisas como: “Não sei o
                      que aconteceu comigo, mas não consigo viver sem você.”
                    </p>
                  </div>
                  <Paragraph className="font-bold text-center mt-4">
                    Ou… se não havia ninguém específico, alguém novo surge,
                ...
                <Section>
                  ...
                  <Paragraph>
                    Quando a Sacerdotisa Azara realiza esse ritual, as pessoas não
                    apenas voltam.
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Elas grudam.
                    ...
                    <br />
                    Elas não se cansam de você.
                  </Paragraph>
                  <Paragraph className="text-center font-bold text-destructive border-2 border-destructive p-4 rounded-lg">
                    Se você não está pronta(o) para essa pessoa te desejar a cada
                    segundo de todos os dias… não faça isso.
                  </Paragraph>
                </Section>

                <Section>
                  <SectionTitle>
                    Histórias reais de pessoas que usaram a chama
                  </SectionTitle>
                  <Testimonials />
                </Section>
                ...
                <Section>
                  <SectionTitle>
                    A História Proibida Que Tentaram Enterrar
                  </SectionTitle>
                  ...
                  <Paragraph>
                    Mais antigo que qualquer conselho de relacionamento que você
                    já ouviu.
                  </Paragraph>
                  <Paragraph>
                    Pessoas usam o fogo para ligar corações há milhares de anos.
                  </Paragraph>
                  <Paragraph>Em templos persas antigos.</Paragraph>
                  <Paragraph>Em câmaras escondidas.</Paragraph>
                  <Paragraph>
                    Em cerimônias secretas passadas de geração em geração.
                  </Paragraph>
                  <Paragraph>
                  ...
                  <Paragraph className="font-bold text-center text-xl">
                    ...
                    <br />
                    Todo ser humano pode ser incendiado por alguém.
                  </Paragraph>
                ...
                <Section>
                  ...
                  />
                  <Paragraph>
                    Existem histórias — sussurradas, apagadas dos livros de
                    história — sobre rainhas e reis que usaram a chama sagrada
                    para trazer seus amores de volta.
                  </Paragraph>
                  <Paragraph>
                    Uma rainha — ou um rei — mandou realizar o ritual enquanto a
                    pessoa amada estava longe, envolvida em outra relação, em
                  ...
                  <Paragraph>
                    Voltou correndo, pálido(a) e tremendo(a), sussurrando:
                  </Paragraph>
                  <Paragraph className="italic">
                ...
                <Section>
                  ...
                  <Paragraph>
                    Quando os sacerdotes perceberam o que as guardiãs do fogo
                    faziam com a chama sagrada?
                  </Paragraph>
                  <Paragraph>Entraram em pânico.</Paragraph>
                  <Paragraph>Chamaram de mal.</Paragraph>
                  <Paragraph>
                    Disseram que ameaçava a ordem natural.
                  </Paragraph>
                  <Paragraph>Por quê?</Paragraph>
                  <Paragraph>Porque funcionava.</Paragraph>
                  <Paragraph>
                    Porque pessoas “lógicas” desmoronavam como crianças.
                  </Paragraph>
                  <Paragraph>
                    Porque pessoas “fortes” choravam como bebês.
                  </Paragraph>
                  <Paragraph>
                    Porque pessoas “fiéis” abandonavam tudo para rastejar de volta
                    a quem incendiou sua alma.
                  </Paragraph>
                  <Paragraph>
                    Então proibiram. Queimaram os textos. Espalharam as
                    sacerdotisas e guardiões.
                  </Paragraph>
                  <Paragraph>Mas sussurros nunca morrem.</Paragraph>
                  <Paragraph>
                    O conhecimento sobreviveu. Passado em segredo, de guardiã para
                    guardião, de geração em geração.
                  </Paragraph>
                  <Paragraph className="font-bold text-center text-xl">
                    E agora está aqui. Pronto para ligar a alma da pessoa que
                    você deseja à sua.
                  </Paragraph>
                </Section>
                ...
                <Section className="text-center">
                  ...
                  <Paragraph className="mt-6">
                    A Sacerdotisa Azara é descendente direta dos guardiões do fogo
                    zoroastristas da antiga Pérsia.
                  </Paragraph>
                  <Paragraph>
                    A família dela guarda a chama sagrada há mais de 1.500 anos.
                    Quando os templos foram destruídos, eles fugiram com as
                    brasas, mantendo a tradição viva em segredo.
                  </Paragraph>
                  <Paragraph>
                    Hoje, ela realiza o ritual da chama em seu templo particular
                    para um número limitado de pessoas por semana.
                  </Paragraph>
                  <Paragraph>
                    Ela não faz isso por dinheiro. É o chamado dela. O propósito
                    dela. Garantir que esse poder antigo não se perca no mundo.
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Mas o ritual a drena. Cada um exige dias de preparação e
                    recuperação. Por isso ela só pode ajudar um número limitado de
                    pessoas.
                  </Paragraph>
                </Section>
                ...
                <Section>
                  ...
                  <div className="space-y-4 text-center">
                    <p>
                      <strong>1 –</strong> Você clica no botão abaixo e preenche
                      um formulário curto com o nome da pessoa desejada ou solicita
                      a abertura para um novo amor.
                    </p>
                    <p>
                      <strong>2 –</strong> A Sacerdotisa Azara realiza o Ritual da
                      Chama de 5 Noites em seu templo.
                    </p>
                    <p>
                      <strong>3 –</strong> Você segue com a sua vida enquanto a
                      chama faz o trabalho.
                    </p>
                    <p>
                      <strong>4 –</strong> Em até 5 noites, veja o fogo agir.
                    </p>
                  </div>
                  <Paragraph className="text-center mt-4">
                    É isso. Você não precisa fazer nada além de estar pronta(o)
                ...
                <Section className="text-center bg-card/80 p-6 rounded-2xl shadow-2xl shadow-primary/10 backdrop-blur-sm">
                  <SectionTitle>
                    Quanto Vale a Obsessão Dessa Pessoa Para Você?
                  </SectionTitle>
                  <Paragraph>Seja honesta(o).</Paragraph>
                  <Paragraph>
                    Quanto você pagaria para acabar com a humilhação de ser
                    ignorada(o)?
                  </Paragraph>
                  <Paragraph>
                  ...
                  <Paragraph>
                    Para vê-la de joelhos, implorando por outra chance?
                  </Paragraph>
                  <Paragraph>
                    Pessoas gastam milhares em terapia e coaches que não
                    funcionam. Perdem meses com estratégias de “nenhum contato” que
                    não levam a lugar nenhum.
                  </Paragraph>
                  <Paragraph>
                    Nada disso liga o interruptor da obsessão dessa pessoa.
                  </Paragraph>
                  <Paragraph className="font-bold">
                ...
                <Section className="text-center">
                  ...
                  <Paragraph>
                    A Sacerdotisa Azara não faz isso por lucro. Mas precisamos
                    cobrir os custos de manter este site e o templo dela.
                  </Paragraph>
                  <Paragraph>
                    Então concordamos em um valor acessível para qualquer pessoa,
                  ...
                  <Paragraph className="text-2xl">
                    Hoje, você pode ter o Ritual da Chama de 5 Noites realizado
                    por apenas{" "}
                  ...
                  <Paragraph className="font-bold text-xl">
                    Pelo poder de fazer essa pessoa queimar por você para sempre.
                  </Paragraph>
                </Section>
                ...
                <Section className="text-center bg-card/80 p-6 rounded-2xl shadow-2xl shadow-primary/10 backdrop-blur-sm my-8">
                  <h3 className="font-headline text-2xl font-bold text-center text-primary mb-4">
                    🎁 BÔNUS EXCLUSIVOS PARA QUEM FAZER O RITUAL HOJE
                  </h3>
                  <p className="text-lg text-foreground/80 mb-6">
                    ⚠️ ATENÇÃO: Estes bônus não são vendidos separadamente. Eles só
                    são liberados para quem ativa o Ritual do Fogo HOJE.
                  </p>
                  <div className="space-y-4 text-left">
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #1 – Ativação do Vínculo Energético Noturno
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$97</span>
                        <br />
                        Ativação extra durante as 5 noites do ritual, fortalecendo
                        o vínculo enquanto a pessoa dorme, intensificando sonhos,
                        pensamentos involuntários e o chamado emocional.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #2 – Ritual de Corte de Terceiras Pessoas
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$127</span>
                        <br />
                        Ritual silencioso para esfriar qualquer interferência
                        externa, afastando rivais e conexões paralelas sem
                        confronto ou conflitos.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #3 – Selamento da Chama (Anti-Arrependimento)
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$147</span>
                        <br />
                        Após a quinta noite, a chama é selada para evitar
                        esfriamento, afastamentos futuros ou recaídas emocionais.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #4 – Abertura para Amor Novo (se não houver nome
                        específico)
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$97</span>
                        <br />
                        Ativação energética para atrair uma nova pessoa alinhada,
                        com conexão intensa desde o primeiro contato.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #5 – Proteção Energética da Chama
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$87</span>
                        <br />
                        Blindagem contra inveja, interferências externas e
                        energias negativas que possam enfraquecer o ritual.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold">
                        🔥 BÔNUS #6 – Prioridade Máxima no Templo
                      </h4>
                      <p className="text-foreground/80">
                        Valor real: <span className="line-through">R$67</span>
                        <br />
                        Seu ritual é iniciado imediatamente, na mesma noite, sem
                        fila de espera.
                      </p>
                    </div>
                  </div>
                  <div className="mt-8">
                    <p className="text-xl font-bold">
                      👉 VALOR TOTAL REAL: <span className="line-through">R$819</span>
                    </p>
                    <p className="text-2xl font-bold text-destructive mt-2">
                      ⚠️ MAS FAZENDO HOJE…
                    </p>
                    <p className="text-xl font-bold mt-2">
                      FAZENDO HOJE O RITUAL DO FOGO VOCÊ GANHA TOTALMENTE GRÁTIS:
                    </p>
                ...
                <Section className="text-center">
                  ...
                  />
                  <Paragraph>
                    A Sacerdotisa Azara só consegue realizar um número limitado de
                    rituais por semana. A energia dela não é infinita. Quando as
                    vagas acabam, acabam — até ela se recuperar.
                  </Paragraph>
                  <Paragraph>
                    Se você fechar esta página e voltar amanhã, sua vaga pode já
                    ter sido tomada.
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Cada noite que você espera é mais uma noite em que essa pessoa
                    se afasta.
                  </Paragraph>
                  <Paragraph className="font-bold">
                  ...
                  <Paragraph className="font-bold">
                    Mais uma noite que você perde.
                  </Paragraph>
                  <Paragraph className="text-2xl font-bold text-destructive my-6">
                    E Aqui Está a Verdade Mais Sombria…
                  </Paragraph>
                  <Paragraph>Esta página pode não ficar no ar.</Paragraph>
                  <Paragraph>
                    Eles já tentaram enterrar esse ritual antes.
                  </Paragraph>
                  <Paragraph>
                    Terapeutas, coaches de relacionamento, toda a indústria de
                    “autoajuda” — eles adorariam ver isso desaparecer.
                  </Paragraph>
                  <Paragraph>
                    Porque quando as pessoas têm esse poder, ninguém tem chance.
                  </Paragraph>
                  <Paragraph>
                    Não posso prometer que esta página estará aqui amanhã.
                  </Paragraph>
                  <Paragraph>Mas posso prometer isto:</Paragraph>
                  <Paragraph className="font-bold text-primary text-xl">
                    👉 Se você agir agora, a Sacerdotisa Azara começará seu ritual
                    ainda hoje à noite.
                  </Paragraph>
                  <Paragraph className="font-bold text-destructive text-xl">
                    👉 Se você esperar, talvez nunca mais veja esta página — ou
                ...
                <Section className="text-center border-2 border-green-500 rounded-lg p-6 bg-green-500/10">
                  ...
                  <Paragraph>
                    Você tem 7 dias completos para ver os resultados.
                  </Paragraph>
                  <Paragraph>
                    Se essa pessoa não estiver queimando de obsessão por você…
                  </Paragraph>
                  <Paragraph>
                    Se essa pessoa não voltar rastejando, implorando pelo seu
                    perdão…
                  </Paragraph>
                  <Paragraph>
                    Se você não ficar completamente chocado(a) com o nível de
                    desespero dessa pessoa por você…
                  </Paragraph>
                  <Paragraph className="font-bold">
                    Basta enviar um e-mail e você recebe cada centavo de volta.
                    Sem perguntas. Sem complicações.
                  </Paragraph>
                  <Paragraph className="mt-6 font-semibold">
                    Ou você recupera essa pessoa, totalmente devota a você, ou
                ...
                <Section>
                  ...
                  <div className="space-y-6 max-w-2xl mx-auto">
                    <div>
                      ...
                      <Paragraph>
                        Ótimo. Essa outra pessoa é apenas um espaço vazio. A chama
                        não compete — ela apaga. A conexão dela com essa pessoa
                        esfria. O toque parece errado. A voz irrita. Ela olha e
                        sente apenas vazio. E então corre de volta para você.
                      </Paragraph>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-primary">
                      ...
                      <Paragraph>
                        Melhor ainda. O bloqueio não protege. Ele prende a pessoa
                        dentro da própria cabeça com o fogo. Ela ficará tão
                        obcecada que dará um jeito de falar com você — uma conta
                        nova, um e-mail, aparecendo pessoalmente. O bloqueio vira
                        a prisão dela, e você é a única saída.
                      </Paragraph>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-primary">
                        E se já se passaram meses ou anos?
                      </h3>
                      <Paragraph>
                        Não importa. O tempo não apaga essa chama. A conexão entre
                        vocês ainda existe como uma brasa enterrada. Esse ritual é
                        o vento que transforma essa brasa em incêndio. Quanto mais
                        tempo passou, mais forte as memórias batem quando voltam.
                      </Paragraph>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-primary">
                      ...
                      <Paragraph>
                        ...
                        palavras não significam nada quando a alma está em chamas.
                        Na quinta noite, ela nem vai lembrar do que jurou. Estará
                        ocupada demais implorando para você aceitá-la de volta.
                      </Paragraph>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-primary">
                      ...
                      <Paragraph>
                        Você não precisa acreditar. O fogo não liga para crença.
                        Ele queima de qualquer forma. Tudo o que você precisa
                        fazer é entregar o nome à Sacerdotisa Azara. Ela cuida do
                        resto.
                      </Paragraph>
                    </div>
                    <div>
                      ...
                      <Paragraph>
                        Sim. Por isso eu avisei. Não é temporário. Uma vez que o
                        nome entra na chama, o vínculo é selado. Não faça isso se
                        não tiver certeza de que quer essa pessoa ligada a você.
                      </Paragraph>
                    </div>
                  </div>
        ...
        {showRitual && (
          <RitualForm onClose={handleCloseRitual} checkoutUrl="https://pay.kirvano.com/c298ed00-5e07-4499-8eb4-6426ba33068d" />
        )}
      </div>
    </>
  );
