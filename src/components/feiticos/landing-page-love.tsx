      ...
      <main>
        ...
        <Section className="text-center bg-card/80 p-6 rounded-2xl shadow-2xl shadow-primary/10 backdrop-blur-sm">
            ...
            <div className="my-6 text-left text-foreground/90 p-4 border border-primary/20 rounded-lg bg-primary/5 space-y-2">
                ...
                <p><strong>BÔNUS 1 <span className="text-green-500">✔️</span> Ritual de Proteção Amorosa</strong> — protege o feitiço contra inveja, energias negativas e interferência de terceiros, garantindo que o amor permaneça firme e blindado.</p>
                <p><strong>BÔNUS 2 <span className="text-green-500">✔️</span> Oração da Conexão Imediata</strong> — ativa sinais rápidos como mensagens, pensamentos recorrentes e aproximações espontâneas da pessoa destinada a você.</p>
                <p><strong>BÔNUS 3 <span className="text-green-500">✔️</span> Ritual da Lua do Amor</strong> — potencializa o feitiço principal em noites especiais, multiplicando a força da paixão, do desejo e da união emocional.</p>
                <p><strong>BÔNUS 4 <span className="text-green-500">✔️</span> Chamada Amorosa (para novos amores)</strong> — atrai a pessoa predestinada quando você não tem ninguém específico em mente, alinhando o universo ao seu favor.</p>
                <p><strong>BÔNUS 5 <span className="text-green-500">✔️</span> Mensagem de Ativação Personalizada</strong> — prepara sua energia emocional e espiritual para receber o amor, evitando bloqueios e acelerando os resultados do ritual.</p>
