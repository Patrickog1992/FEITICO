...
export default function DynamicDateBanner() {
  ...
  return (
    <div className="bg-yellow-400 text-black text-center p-3 font-bold animate-pulse w-full max-w-4xl mx-auto rounded-lg mb-4">
      ATENÇÃO: No dia <strong className="underline">{currentDate}</strong>, as energias cósmicas estão mais abertas — e o feitiço de Lady Soraya será até 3x mais forte, aproveite!
    </div>
  );
}
