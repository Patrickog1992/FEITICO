...
export default function Upsell2Page() {
  return (
    <div className="bg-background text-foreground min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <main>
        <div 
          dangerouslySetInnerHTML={{ __html: `<vturb-smartplayer id="vid-6981f7cb8cb5dc32dbfcb8c9" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>` }}
        />
        <Script 
          src="https://scripts.converteai.net/66f7b845-c900-4cf3-b6f2-f848ebd65e7f/players/6981f7cb8cb5dc32dbfcb8c9/v4/player.js" 
