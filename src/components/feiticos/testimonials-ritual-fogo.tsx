...
const testimonialsData = [
  ...
  },
  {
    ...
    text: "Meu relacionamento estava por um fio. Depois do ritual da chama, a energia entre nós mudou completamente. Ele se tornou mais carinhoso, atencioso e finalmente me pediu em casamento! Sou eternamente grata.",
  },
  {
    name: "Sofia Oliveira",
  ...
  },
  {
    ...
    text: "Havia outra mulher na jogada, e eu pensei que tinha perdido ele para sempre. O ritual não só o trouxe de volta, como afastou a rival de uma vez por todas. Hoje, ele só tem olhos para mim.",
  },
  {
    name: "Clara Martins",
    avatar: "https://i.imgur.com/sqYjS4V.png",
    text: "Estávamos separados há meses. Depois que o nome dele foi sussurrado na chama, ele começou a curtir minhas fotos, me mandou mensagem e hoje estamos planejando nosso futuro juntos. Foi a melhor decisão que já tomei.",
  },
  {
    name: "Larissa Souza",
    avatar: "https://i.imgur.com/SPsVs9s.jpg",
    text: "O ritual da chama é poderoso. Ele voltou mais apaixonado do que nunca. A Sacerdotisa Azara realmente sabe o que faz. Recomendo a todas que estão sofrendo por amor.",
  },
];
...
export default function TestimonialsRitualFogo() {
