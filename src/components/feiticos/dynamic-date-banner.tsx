...
export default function DynamicDateBanner() {
  ...
  return (
    <div className="bg-yellow-400 text-black text-center p-2 text-sm font-semibold w-full max-w-4xl mx-auto rounded-lg mb-4">
      ATENÇÃO: No dia <span className="bg-white text-yellow-500 px-2 py-1 rounded-md mx-1">{currentDate}</span>, as energias cósmicas estão mais abertas e o feitiço de Lady Soraya será até 3x mais forte, aproveite!
    </div>
  );
}
