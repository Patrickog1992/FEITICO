    ...
    <div className="w-full max-w-4xl mx-auto">
       <header className="text-center my-8 md:my-12">
        ...
        <div className="bg-primary text-primary-foreground p-6 rounded-lg mt-4">
            ...
            Ajudar 4747 mulheres a criarem o amor de suas vidas
            </p>
        </div>
      </header>
      ...
      <main>
        ...
        <Section className="text-center bg-card/80 p-6 rounded-2xl shadow-2xl shadow-primary/10 backdrop-blur-sm">
            ...
            <Paragraph>E quanto isso custa? Nada comparado ao valor do amor verdadeiro. Lady Soraya não busca lucro — apenas cumprir sua missão. Mas, para manter o site, foi necessário cobrar um valor simbólico. <span className="text-green-500 font-bold">Apenas R$47,47</span> — um número sagrado — para as 4747 mulheres escolhidas. Mesmo que você esteja passando por dificuldades... Mesmo que seja mãe solo... Mesmo que tenha perdido as esperanças... Este é o seu sinal.</Paragraph>
