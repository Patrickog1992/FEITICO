...
import Testimonials from "./testimonials-lp";
    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      <main>
        <Section className="text-center">
            <h2 className="font-headline text-3xl font-bold text-center text-primary mb-6">A Sacerdotisa do Amor revela:<br/>💘 O feitiço proibido capaz de despertar um amor tão poderoso que une duas almas recuperando o que foi perdido ou atraindo alguém totalmente novo e destinado a você.</h2>
          <Image
          ...
          <Paragraph className="mt-6">
            Mesmo que exista outra pessoa na história…
            Mesmo que ela esteja distante…
            Mesmo que não esteja “pronta” para um compromisso.
          </Paragraph>
          <Paragraph>
        ...
        <Section>
            ...
            <Paragraph className="border-l-4 border-primary pl-4 italic font-semibold">
                Quero que você entenda que o feitiço de amor que vou te revelar é <span className="font-bold text-destructive">irreversível</span>. Uma vez que você use este feitiço proibido na pessoa que escolher... Não há volta. A única forma de quebrar este feitiço é — a morte. Ou seja, será mesmo até o fim.
            </Paragraph>
        </Section>
        ...
        <Section className="text-center">
            <Image
                ...
                className="rounded-lg shadow-lg mx-auto"
            />
            <Paragraph className="mt-4">(Essa história funciona para você independente do seu gênero)</Paragraph>
        ...
        <Section className="text-center bg-card/80 p-6 rounded-2xl shadow-2xl shadow-primary/10 backdrop-blur-sm">
            ...
            />
            <Paragraph>
              💗 As pessoas que procuram Lady Soraya hoje se dividem em dois caminhos:
              <br/><br/>
              1️⃣ Quem quer trazer um amor de volta
              — um ex que se afastou, esfriou, sumiu, bloqueou ou parece distante.
              <br/><br/>
              2️⃣ Quem quer atrair um novo amor verdadeiro
              — pessoas solteiras, cansadas de encontros vazios, que sentem que nunca encontram alguém compatível ou “feito pra elas”.
              <br/><br/>
            ...
            <Paragraph>
              E mesmo que você não tenha ninguém específico em mente, o feitiço também funciona: 
              <br/>
            ...
            <div className="my-6 text-left text-foreground/90 p-4 border border-primary/20 rounded-lg bg-primary/5 space-y-2">
                ...
                <p><strong>BÔNUS 1 (valor R$97) <span className="text-green-500">✔️</span> Ritual de Proteção Amorosa</strong> — protege o feitiço contra inveja, energias negativas e interferência de terceiros, garantindo que o amor permaneça firme e blindado.</p>
                <p><strong>BÔNUS 2 (valor R$67) <span className="text-green-500">✔️</span> Oração da Conexão Imediata</strong> — ativa sinais rápidos como mensagens, pensamentos recorrentes e aproximações espontâneas da pessoa destinada a você.</p>
                <p><strong>BÔNUS 3 (valor R$127) <span className="text-green-500">✔️</span> Ritual da Lua do Amor</strong> — potencializa o feitiço principal em noites especiais, multiplicando a força da paixão, do desejo e da união emocional.</p>
                <p><strong>BÔNUS 4 (valor R$97) <span className="text-green-500">✔️</span> Chamada Amorosa (para novos amores)</strong> — atrai a pessoa predestinada quando você não tem ninguém específico em mente, alinhando o universo ao seu favor.</p>
                <p><strong>BÔNUS 5 (valor R$77) <span className="text-green-500">✔️</span> Mensagem de Ativação Personalizada</strong> — prepara sua energia emocional e espiritual para receber o amor, evitando bloqueios e acelerando os resultados do ritual.</p>
